...
const Hero = () => {
  return (
    ...
    >
      ...
      <motion.h2
        variants={itemB}
        className="mt-5 text-xl font-bold text-gray-500 text-center"
      >
        Extract, Analyze, Summarize, and Classify for Better Content Creation!
      </motion.h2>
      <motion.p
        variants={itemB}
        className="mt-10 max-w-lg md:max-w-3xl text-lg font-extralight tracking-wider leading-7 text-gray-600 text-center"
      >
